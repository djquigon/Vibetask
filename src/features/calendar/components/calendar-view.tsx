...
// neutral buttons
export const strongSolidPressableClass =
...
const getSlotClass = (info: { isMinor: boolean }) =>
    joinClassNames(
...
const dayRowCommonClasses: CalendarOptions = {
    ...
    rowEventClass: (info) =>
        joinClassNames(
            info.isStart &&
                joinClassNames(
                    'rounded-s-sm',
                    info.isNarrow ? 'ms-px' : 'ms-0.5'
                ),
            info.isEnd &&
                joinClassNames(
                    'rounded-e-sm',
                    info.isNarrow ? 'me-px' : 'me-0.5'
                )
        ),
  ...
  ----------------------------------------------------------------------------------------------- */
    ...
    rowMoreLinkInnerClass: (info) =>
        joinClassNames('p-px', info.isNarrow ? xxsTextClass : 'text-xs'),
};
...
export function CalendarView({
    ...
    return (
        <FullCalendar
            ...
            viewClass={(info) => {
                const hasBorderTop =
                    info.options.headerToolbar || !info.borderlessTop;
                const hasBorderBottom =
                    info.options.footerToolbar || !info.borderlessBottom;
      ...
      ------------------------------------------------------------------------------------------- */
            ...
            buttons={{
                prev: {
                    iconContent: () =>
                        chevronLeft(
                            `${buttonIconClass} [[dir=rtl]_&]:rotate-180`
                        ),
                },
                next: {
                    iconContent: () =>
                        chevronLeft(
                            `${buttonIconClass} rotate-180 [[dir=rtl]_&]:rotate-0`
                        ),
                },
                prevYear: {
                    iconContent: () =>
      ...
      ------------------------------------------------------------------------------------------- */
            ...
            backgroundEventTitleClass={(info) =>
                joinClassNames(
                    ...
                    info.isNarrow ? `p-0.5 ${xxsTextClass}` : 'p-1.5 text-xs'
                )
            }
            /* List-Item Event
      ------------------------------------------------------------------------------------------- */
      ...
      ------------------------------------------------------------------------------------------- */
            ...
            columnEventTimeClass={(info) =>
                joinClassNames(!info.isShort && 'pt-0.5', xxsTextClass)
            }
      ...
      ------------------------------------------------------------------------------------------- */
            ...
            views={{
                ...
                multiMonth: {
                    ...
                    tableClass: (info) =>
                        joinClassNames(
                            info.multiMonthColumns > 1 &&
                                'border-(--fc-classic-border) border'
                        ),
          ...
          --------------------------------------------------------------------------------------- */
                    ...
                    allDayDividerClass:
                        'border-y border-(--fc-classic-border) pb-0.5 bg-(--fc-classic-muted)',
          ...
          --------------------------------------------------------------------------------------- */
                    ...
                    slotHeaderDividerClass:
                        'border-e border-(--fc-classic-border)',

                    /* TimeGrid > Now-Indicator
          --------------------------------------------------------------------------------------- */

                    nowIndicatorHeaderClass:
                        'start-0 -mt-[5px] border-y-[5px] border-y-transparent border-s-[6px] border-s-(--fc-classic-now)',
